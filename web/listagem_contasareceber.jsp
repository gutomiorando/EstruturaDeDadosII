<%-- 
    Document   : listagem_contasareceber
    Created on : 19/11/2017, 14:36:28
    Author     : Usuario
--%>
...
<script type="text/javascript">
    ...
    function filtrarUsuario()
    {
        ...
        http.open("GET", "listagem_contasareceber_tabela.jsp?pesquisa=" + pesquisa + "&origem=" + origem, true);
        http.send();
...
<%
    ArrayList<Object> contas3DAO = new ContasareceberDAO().consultarTodos();
...
<header class="page-header">
    <div class="container-fluid">
        <h2 class="no-margin-bottom">Listagem de Contas a Receber</h2>
    </div>
</header>
<!-- Breadcrumb-->
<ul class="breadcrumb">
                                ...
                                <tbody>
                                    <%
                                        ...
                                        for (int i = 0; i < contas3DAO.size(); i++) {
                                            Contasareceber cont = (Contasareceber) contas3DAO.get(i);
                                    %>
                                    <tr>
